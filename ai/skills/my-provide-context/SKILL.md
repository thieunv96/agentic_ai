...
1. Organize into .note/KNOWLEDGE.md
2. Run quick research (summarize papers, identify key approaches and challenges)
3. Create or update .note/ROADMAP.md with ML phases
...
<execution_context>
@.github/my/workflows/provide-context.md
...
<process>
Execute the provide-context workflow from @.github/my/workflows/provide-context.md end-to-end.
</process>
