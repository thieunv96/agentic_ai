...
For `version` reports also creates: `.note/VERSION-REPORT.md` (permanent artifact)
</objective>

<execution_context>
@.github/my/workflows/report.md
</execution_context>
...
<process>
Execute the report workflow from @.github/my/workflows/report.md end-to-end.
