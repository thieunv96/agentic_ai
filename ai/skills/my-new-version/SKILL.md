...
<objective>
Initialize a new ML/AI project version. Creates the .note/ structure, asks ML-focused questions (task type, dataset, target metrics, compute), and prepares STATE.md for the first context-providing step.
</objective>
