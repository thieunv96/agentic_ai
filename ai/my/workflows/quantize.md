...
.note/phases/[phase-dir]/EVALUATION.md
</files_to_read>
...
Save to: .note/phases/[phase-dir]/QUANTIZATION-REPORT.md
...
node ".github/my/bin/my-tools.cjs" commit "model(phase-[N]): quantize [{formats}] - {best_format} {speedup}x speedup" --files .note/phases/[phase-dir]/QUANTIZATION-REPORT.md models/
```
...
**Report:** `.note/phases/[phase-dir]/QUANTIZATION-REPORT.md`
