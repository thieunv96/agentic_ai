...
Template for `.note/debug/[slug].md` — active debug session tracking.
...
**Creation:** Immediately when /my-debug is called
...
**On resolution:**
- status → "resolved"
- Move file to .note/debug/resolved/ (only after user confirms fix)
