...
Template for `.note/codebase/STRUCTURE.md` - captures physical file organization.
...
**my/templates/**
- Purpose: Document templates for .note/ files
...
**New Slash Command:**
- Primary code: `commands/ai/{command-name}.md`
- Tests: `tests/commands/{command-name}.test.js` (if testing implemented)
- Documentation: Update `README.md` with new command

**New Template:**
- Implementation: `my/templates/{name}.md`
- Documentation: Template is self-documenting (includes guidelines)

**New Workflow:**
- Implementation: `my/workflows/{name}.md`
- Usage: Reference from command with `@.github/my/workflows/{name}.md`

**New Reference Document:**
- Implementation: `my/references/{name}.md`
