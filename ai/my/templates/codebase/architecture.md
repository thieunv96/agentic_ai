...
Template for `.note/codebase/ARCHITECTURE.md` - captures conceptual code organization.
...
**State Management:**
- File-based: All state lives in `.note/` directory
