...
Template for `.note/phases/XX-name/{phase_num}-RESEARCH.md` - comprehensive ecosystem research before planning.
...
**CRITICAL:** If CONTEXT.md exists from /my-discuss-phase, copy locked decisions here verbatim. These MUST be honored by the planner.
...
**Structure:**
- Use XML tags for section markers (matches AI templates)
...
**After creation:**
- File lives in phase directory: `.note/phases/XX-name/{phase_num}-RESEARCH.md`
