...
Template for `.note/phases/XX-name/{phase_num}-CONTEXT.md` - captures implementation decisions for a phase.
...
- `my-researcher` — Reads decisions to focus research (e.g., "ViT backbone" → research ViT fine-tuning patterns for this task)
- `my-planner` — Reads decisions to create specific tasks (e.g., "LoRA fine-tuning" → task includes LoRA adapter implementation)
- `my-data-analyst` — Reads dataset decision to scope analysis
...
<ml_context>
## ML Phase Context (for CV/VLM phases)

### Papers Referenced
[Papers from KNOWLEDGE.md relevant to this phase]
- `[Paper Title]` — [Specific insight relevant to this phase]

### Code References Used
[Code refs from KNOWLEDGE.md guiding implementation]
- `[repo/path]` — [How it informs this phase]

### Prior Experiments
[If any prior runs inform this phase's decisions]
- Experiment [N]-[run]: [Key finding that affects decisions]

### Target Metrics
[Specific measurable criteria for this phase]
| Metric | Target | How to Measure |
|--------|--------|----------------|
| [metric] | [value] | [eval script/method] |

### Implementation Constraints
[GPU, framework, library constraints]
- Framework: [PyTorch / TensorFlow / JAX]
- GPU: [available hardware]
- Max memory: [per-GPU memory budget]
...
**After creation:**
- File lives in phase directory: `.note/phases/XX-name/{phase_num}-CONTEXT.md`
- `my-phase-researcher` uses decisions to focus investigation AND reads canonical_refs to know WHAT docs to study
- `my-planner` uses decisions + research to create executable tasks AND reads canonical_refs to verify alignment
