...
This template is used by the complete-milestone workflow to create archive files in `.note/milestones/`.
...
_For current project status, see .note/ROADMAP.md_
...
- Save to `.note/milestones/v{VERSION}-{NAME}.md`
- Example: `.note/milestones/v1.0-mvp.md`
