...
Template for `.note/phases/XX-name/{phase_num}-UAT.md` — persistent UAT session tracking.
...
- This section feeds directly into /my-plan-phase --gaps
...
5. status → "diagnosed"
6. Ready for /my-plan-phase --gaps with root causes
...
- truth: "Comment appears immediately after submission"
  ...
  debug_session: ".note/debug/comment-not-refreshing.md"
```
...
**Creation:** When /my-verify-work starts new session
...
- `/my-verify-work {phase}` picks up from first pending/blocked test
