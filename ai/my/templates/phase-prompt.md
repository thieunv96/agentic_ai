...
> **Note:** Planning methodology is in `agents/my-planner.md`.
> This template defines the PLAN.md output format that the agent produces.

Template for `.note/phases/XX-name/{phase}-{plan}-PLAN.md` - executable phase plans optimized for parallel execution.
...
@.github/my/references/checkpoints.md
</execution_context>
...
<!-- For checkpoint task examples and patterns, see @.github/my/references/checkpoints.md -->
...
**Wave is pre-computed:** Wave numbers are assigned during `/my-plan-phase`. Execute-phase reads `wave` directly from frontmatter and groups plans by wave number. No runtime dependency analysis needed.
...
```markdown
<context>
@.note/phases/03-features/03-01-SUMMARY.md  # Just because it's earlier
@.note/phases/03-features/03-02-SUMMARY.md  # Reflexive chaining
</context>
```
...
See `.github/my/references/tdd.md` for TDD plan structure.
...
<output>
After completion, create `.note/phases/03-features/03-01-SUMMARY.md`
</output>
```
...
@.note/PROJECT.md
@.note/ROADMAP.md
@.note/phases/03-features/03-01-SUMMARY.md
@.note/phases/03-features/03-02-SUMMARY.md
</context>
...
<output>
After completion, create `.note/phases/03-features/03-03-SUMMARY.md`
</output>
```
...
See `.github/my/templates/user-setup.md` for full schema and examples
...
See `.github/my/workflows/verify-phase.md` for verification logic.
