...
Usage: `/ai-map-codebase` or `/ai-map-codebase ./path/to/project`
</objective>

<execution_context>
@.github/ai/workflows/map-codebase.md
</execution_context>
...
<process>
Execute the map-codebase workflow from @.github/ai/workflows/map-codebase.md end-to-end.
