...
Different from `asilla-evaluate` (which evaluates models) and `asilla-status` (which checks progress).
...
<execution_context>
@.github/asilla/workflows/data-prep.md
@.github/asilla/references/ml-data-engineering.md
</execution_context>
...
<process>
Execute the data-prep workflow from @.github/asilla/workflows/data-prep.md end-to-end.
