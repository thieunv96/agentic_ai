...
agent: asilla-planner
allowed-tools: Read, Write, Edit, Bash, Glob, Grep, Task, WebFetch
---

<objective>
Create executable PLAN.md files for a phase. Spawns asilla-planner with ML context.
Default flow: Research (via asilla-ml-researcher) → Plan → Verify with asilla-plan-checker → Done
Commit: "docs: plan phase {N} - {name}"
</objective>

<execution_context>
@.github/asilla/workflows/plan.md
...
<process>
Execute the plan workflow from @.github/asilla/workflows/plan.md end-to-end.
</process>
