...
Usage: `/asilla-map-codebase` or `/asilla-map-codebase ./path/to/project`
</objective>

<execution_context>
@.github/asilla/workflows/map-codebase.md
</execution_context>
...
<process>
Execute the map-codebase workflow from @.github/asilla/workflows/map-codebase.md end-to-end.
