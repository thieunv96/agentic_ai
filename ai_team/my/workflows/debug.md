<purpose>
Systematic debugging of ML/training/evaluation issues. Spawns my-debugger with context. Produces DEBUG.md with root cause and fix.
</purpose>
...
```bash
node ".github/my/bin/my-tools.cjs" commit "fix([phase]): [brief description of fix]" --files [changed files]
```
