 ...
 *
 * This module centralizes security checks for Asilla tooling. Because Asilla generates
...
const INJECTION_PATTERNS = [
  ...
  // Note: <instructions> is excluded — Asilla uses it as legitimate prompt structure
