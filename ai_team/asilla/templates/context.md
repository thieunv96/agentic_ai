...
- `asilla-ml-researcher` — Reads decisions to focus research (e.g., "ViT backbone" → research ViT fine-tuning patterns for this task)
- `asilla-planner` — Reads decisions to create specific tasks (e.g., "LoRA fine-tuning" → task includes LoRA adapter implementation)
- `asilla-data-analyst` — Reads dataset decision to scope analysis
...
- `asilla-phase-researcher` uses decisions to focus investigation AND reads canonical_refs to know WHAT docs to study
- `asilla-planner` uses decisions + research to create executable tasks AND reads canonical_refs to verify alignment
