...
│   └── asilla/           # Asilla-specific commands
├── asilla/     # Skill resources
...
**New Slash Command:**
- Primary code: `commands/asilla/{command-name}.md`
- Tests: `tests/commands/{command-name}.test.js` (if testing implemented)
- Documentation: Update `README.md` with new command

**New Template:**
- Implementation: `asilla/templates/{name}.md`
- Documentation: Template is self-documenting (includes guidelines)

**New Workflow:**
- Implementation: `asilla/workflows/{name}.md`
- Usage: Reference from command with `@.github/asilla/workflows/{name}.md`

**New Reference Document:**
- Implementation: `asilla/references/{name}.md`
