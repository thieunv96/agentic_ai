...
> **Note:** Planning methodology is in `agents/asilla-planner.md`.
...
@.github/asilla/references/checkpoints.md
</execution_context>
...
<!-- For checkpoint task examples and patterns, see @.github/asilla/references/checkpoints.md -->
...
**Wave is pre-computed:** Wave numbers are assigned during `/asilla-plan-phase`. Execute-phase reads `wave` directly from frontmatter and groups plans by wave number. No runtime dependency analysis needed.
...
See `.github/asilla/references/tdd.md` for TDD plan structure.
...
See `.github/asilla/templates/user-setup.md` for full schema and examples
...
See `.github/asilla/workflows/verify-phase.md` for verification logic.
