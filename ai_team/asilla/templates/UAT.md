...
- This section feeds directly into /asilla-plan-phase --gaps
...
5. status → "diagnosed"
6. Ready for /asilla-plan-phase --gaps with root causes
...
**Creation:** When /asilla-verify-work starts new session
...
- `/asilla-verify-work {phase}` picks up from first pending/blocked test
