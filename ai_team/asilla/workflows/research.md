...
```bash
INIT=$(node ".github/asilla/bin/asilla-tools.cjs" init research "0")
...
After asilla-ml-researcher writes the file, read it back.

Run asilla-research-synthesizer to extract actionable insights if `--deep` mode:
