...
```bash
INIT=$(node ".github/asilla/bin/asilla-tools.cjs" init data-prep "0")
...
Save to: .planning/DATA-PIPELINE.md
...
```bash
node ".github/asilla/bin/asilla-tools.cjs" commit "data: {task_description} - {N} samples {split_ratio} split" --files .planning/DATA-PIPELINE.md scripts/data_prep.py
```
...
**Report:** `.planning/DATA-PIPELINE.md`
