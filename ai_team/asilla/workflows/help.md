<purpose>
Display the complete Asilla ML/AI command reference. Output ONLY the reference content. Do NOT add project-specific analysis, git status, next-step suggestions, or any commentary beyond the reference.
</purpose>

<reference>
# Asilla Command Reference — ML/AI Edition

**Asilla** is an ML/AI development framework for Computer Vision and Vision-Language Model (VLM) projects.

## Core Workflow

```
/asilla-new-version          → Initialize a new version/milestone
/asilla-provide-context      → Ingest papers, code refs, ideas → KNOWLEDGE.md + ROADMAP.md
/asilla-discuss <phase>      → Discuss and lock phase decisions → CONTEXT.md
/asilla-plan <phase>         → Create detailed phase plan → PLAN.md
/asilla-implement <phase>    → Execute plan → code + commits
/asilla-evaluate <phase>     → Evaluate metrics vs targets → EVALUATION.md
/asilla-debug [issue]        → Systematic debugging with persistent state
/asilla-status               → Current project status and next action
/asilla-continue             → Resume from last checkpoint
/asilla-release-version      → Close version with summary + git tag
```

## Research & Exploration

```
/asilla-research [--quick|--deep] <topic>  → Research any ML/CV/VLM topic
/asilla-map-codebase [path]               → Map existing codebase structure
```

## Data & Model Optimization

```
/asilla-data-prep <task> [--convert|--split|--pack|--validate|--push]
    → Build data pipelines: format conversion, splits, WebDataset, LMDB, HF Hub

/asilla-quantize <phase> [--fp16|--int8|--onnx|--trt|--all]
...
```
/asilla-report [session|experiment|version]
...
Usage: `/asilla-new-version`

---

**`/asilla-provide-context [--papers] [--refs] [--idea] [--update]`**
...
Usage: `/asilla-provide-context --papers ./papers/ --idea "train CLIP-style model on custom data"`

---

**`/asilla-release-version <version>`**
...
Usage: `/asilla-release-version 1.0.0`

---

### Phase Workflow

**`/asilla-discuss <phase>`**
...
Usage: `/asilla-discuss 1`
Usage: `/asilla-discuss 2 --auto`
...
- Spawns asilla-planner → reads CONTEXT.md + KNOWLEDGE.md
- Produces `{N}-01-PLAN.md` with concrete tasks and verification criteria
- Optionally spawns asilla-ml-researcher for phase-specific research
...
Usage: `/asilla-evaluate 1`
Usage: `/asilla-evaluate 2 --full`
...
Usage: `/asilla-debug "training loss diverges at epoch 5"`
Usage: `/asilla-debug` (resume active session)
...
Usage: `/asilla-continue`

---

### Research & Exploration

**`/asilla-research [--quick|--deep] <topic>`**
...
Usage: `/asilla-research "LoRA for vision encoders"`
Usage: `/asilla-research --deep "object detection head design"`

---

**`/asilla-map-codebase [path]`**
...
Usage: `/asilla-map-codebase`
Usage: `/asilla-map-codebase ./reference-repo/`
...
Usage: `/asilla-data-prep "convert COCO to HuggingFace and split 80/10/10 --convert --split --validate"`
...
Usage: `/asilla-quantize 3 --all`
Usage: `/asilla-quantize 3 --fp16 --onnx`
...
Usage: `/asilla-report`
Usage: `/asilla-report experiment`
Usage: `/asilla-report version`
