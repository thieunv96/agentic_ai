<purpose>
Evaluate ML model performance for a phase. Spawns asilla-ml-evaluator. Produces EVALUATION.md with go/no-go decision. Commits evaluation results.
</purpose>
...
node ".github/asilla/bin/asilla-tools.cjs" commit "docs: evaluation phase [N] - [metric]=[value]" --files .planning/phases/[phase-dir]/EVALUATION.md .planning/STATE.md
```
