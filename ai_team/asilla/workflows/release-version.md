...
- List failing phases
- Error: "Cannot release — fix gaps first with: /asilla-implement N --gaps-only"
...
```bash
node ".github/asilla/bin/asilla-tools.cjs" commit "docs: release [version] — [task-type] model" --files .planning/
...
---
**Start next version:** `/asilla-new-version v{X+1}`
```
