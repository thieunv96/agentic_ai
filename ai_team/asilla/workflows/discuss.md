...
```bash
node ".github/asilla/bin/asilla-tools.cjs" commit "docs: discuss phase [N] - [phase-name]" --files .planning/phases/[phase-dir]/[N]-CONTEXT.md .planning/phases/[phase-dir]/[N]-DISCUSSION-LOG.md .planning/STATE.md
```
