...
node ".github/asilla/bin/asilla-tools.cjs" commit "model(phase-[N]): quantize [{formats}] - {best_format} {speedup}x speedup" --files .planning/phases/[phase-dir]/QUANTIZATION-REPORT.md models/
```
