...
```bash
INIT=$(node ".github/ai/bin/ai-tools.cjs" init research "0")
...
After ai-researcher writes the file, read it back.

Run ai-research-synthesizer to extract actionable insights if `--deep` mode:
