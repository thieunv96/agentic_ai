<purpose>
Systematic debugging of ML/training/evaluation issues. Spawns ai-debugger with context. Produces DEBUG.md with root cause and fix.
</purpose>
...
```bash
node ".github/ai/bin/ai-tools.cjs" commit "fix([phase]): [brief description of fix]" --files [changed files]
```
