<purpose>
Create PLAN.md files for a phase using ML-aware research and planning. Spawns ai-researcher then ai-planner. Verifies with ai-plan-checker.
</purpose>
...
## 4. Verify (ai-plan-checker)

Spawn ai-plan-checker to verify plans make sense for ML work.
Iterate up to 3 times if issues found.

## 5. Commit

```bash
node ".github/ai/bin/ai-tools.cjs" commit "docs: plan phase [N] - [phase-name]" --files .planning/phases/[phase-dir]/
```
