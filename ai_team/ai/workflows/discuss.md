...
```bash
node ".github/ai/bin/ai-tools.cjs" commit "docs: discuss phase [N] - [phase-name]" --files .planning/phases/[phase-dir]/[N]-CONTEXT.md .planning/phases/[phase-dir]/[N]-DISCUSSION-LOG.md .planning/STATE.md
```
