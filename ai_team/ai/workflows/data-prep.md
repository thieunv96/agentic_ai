...
```bash
INIT=$(node ".github/ai/bin/ai-tools.cjs" init data-prep "0")
...
```bash
node ".github/ai/bin/ai-tools.cjs" commit "data: {task_description} - {N} samples {split_ratio} split" --files .planning/DATA-PIPELINE.md scripts/data_prep.py
```
