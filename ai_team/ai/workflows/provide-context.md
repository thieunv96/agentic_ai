...
```bash
INIT=$(node ".github/ai/bin/ai-tools.cjs" init plan-phase "0")
...
## 4. Quick Research (via ai-researcher)

Spawn ai-researcher with:
```
<files_to_read>
.planning/PROJECT.md
...
Update STATE.md:
- Status: "Ready to discuss — run /ai-discuss 1"
- Add pointer to KNOWLEDGE.md and ROADMAP.md

## 7. Commit

```bash
node ".github/ai/bin/ai-tools.cjs" commit "docs: setup context for [version-name]" --files .planning/KNOWLEDGE.md .planning/ROADMAP.md .planning/STATE.md
```
