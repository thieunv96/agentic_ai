...
- This section feeds directly into /ai-plan-phase --gaps
...
5. status → "diagnosed"
6. Ready for /ai-plan-phase --gaps with root causes
...
**Creation:** When /ai-verify-work starts new session
...
- `/ai-verify-work {phase}` picks up from first pending/blocked test
