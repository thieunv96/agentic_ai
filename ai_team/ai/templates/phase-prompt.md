...
> **Note:** Planning methodology is in `agents/ai-planner.md`.
...
@.github/ai/references/checkpoints.md
</execution_context>
...
<!-- For checkpoint task examples and patterns, see @.github/ai/references/checkpoints.md -->
...
**Wave is pre-computed:** Wave numbers are assigned during `/ai-plan-phase`. Execute-phase reads `wave` directly from frontmatter and groups plans by wave number. No runtime dependency analysis needed.
...
See `.github/ai/references/tdd.md` for TDD plan structure.
...
See `.github/ai/templates/user-setup.md` for full schema and examples
...
See `.github/ai/workflows/verify-phase.md` for verification logic.
