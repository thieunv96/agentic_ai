...
**New Template:**
- Implementation: `ai/templates/{name}.md`
- Documentation: Template is self-documenting (includes guidelines)

**New Workflow:**
- Implementation: `ai/workflows/{name}.md`
- Usage: Reference from command with `@.github/ai/workflows/{name}.md`

**New Reference Document:**
- Implementation: `ai/references/{name}.md`
