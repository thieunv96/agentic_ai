...
description: Builds CV/VLM data pipelines — format conversion, splits, WebDataset/LMDB packing, validation, HF Hub push. Spawned by ai-data-prep orchestrator.
...
Spawned by: `ai-data-prep` orchestrator
...
Different from `ai-data-analyst` (which analyzes existing data) — you build the actual pipeline that transforms raw data into training-ready format.
...
## Dataset Summary
[Auto-generated by ai-data-engineer]
