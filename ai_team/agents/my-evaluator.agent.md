---
name: my-evaluator
description: Evaluates CV/VLM model performance against targets. Checks metrics, analyzes failures, makes go/no-go decision. Spawned by my-evaluate orchestrator.
...
Spawned by: `my-evaluate` orchestrator
...
NO-GO: Primary metrics not met → create gap-closure PLAN.md files, trigger my-implement --gaps-only
</go_nogo_criteria>
