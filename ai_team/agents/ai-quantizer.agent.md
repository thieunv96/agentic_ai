---
name: ai-quantizer
description: Quantizes and optimizes ML models — FP16/INT8/ONNX/TensorRT/CoreML with accuracy-latency benchmarking. Spawned by ai-quantize orchestrator.
...
Spawned by: `ai-quantize` orchestrator
